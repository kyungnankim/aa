...
const Login = ({ onSpotifyLogin }) => {
  return (
    <div className="text-center py-12">
      ...
      <button className="mb-4 w-full max-w-sm mx-auto inline-flex justify-center items-center gap-2 px-6 py-3 bg-gray-100 text-black font-semibold rounded-full hover:bg-gray-200">
        🍎 Apple로 로그인
      </button>

      <button className="w-full max-w-sm mx-auto inline-flex justify-center items-center gap-2 px-6 py-3 bg-white text-black font-semibold rounded-full hover:bg-gray-200">
        🟦 Google로 로그인
      </button>
